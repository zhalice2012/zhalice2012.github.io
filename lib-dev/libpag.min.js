  ...
  class VideoReader {
    ...
    async prepare(targetFrame, playbackRate) {
      ...
      if (currentTime === 0 && targetTime === 0) {
        ...
        if (Math.round(targetTime * this.frameRate) === Math.round(currentTime * this.frameRate)) {
        ...
        } else if ((_a = this.staticTimeRanges) == null ? void 0 : _a.contains(targetFrame)) {
          ...
          if (targetFrame === 53 && ((_b = this.videoEl) == null ? void 0 : _b.width) === 1200) {
            this.isSought = true;
    ...
    seek(targetTime, play = true, targetFrame) {
      return new Promise((resolve) => {
    ...
    return function(PAGInit2) {
      ...
      function SAFE_HEAP_STORE(dest, value, bytes, isFloat) {
        ...
        if (runtimeInitialized) {
          var brk = _sbrk() >>> 0;
          if (dest + bytes > brk)
            abort("segmentation fault, exceeded the top of the available dynamic heap when storing " + bytes + " bytes to address " + dest + ". DYNAMICTOP=" + brk);
      ...
      function SAFE_HEAP_LOAD(dest, bytes, unsigned, isFloat) {
        ...
        if (runtimeInitialized) {
          var brk = _sbrk() >>> 0;
          if (dest + bytes > brk)
            abort("segmentation fault, exceeded the top of the available dynamic heap when loading " + bytes + " bytes from address " + dest + ". DYNAMICTOP=" + brk);
          assert(brk >= _emscripten_stack_get_base());
          assert(brk <= HEAP8.length);
        }
      ...
      var SYSCALLS = {
        ...
        doStat: function(func, path, buf) {
          ...
          tempI64 = [stat.size >>> 0, (tempDouble = stat.size, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], SAFE_HEAP_STORE((buf + 40 >> 2) * 4, tempI64[0], 4), SAFE_HEAP_STORE((buf + 44 >> 2) * 4, tempI64[1], 4);
          SAFE_HEAP_STORE((buf + 48 >> 2) * 4, 4096, 4);
          SAFE_HEAP_STORE((buf + 52 >> 2) * 4, stat.blocks, 4);
          tempI64 = [Math.floor(stat.atime.getTime() / 1e3) >>> 0, (tempDouble = Math.floor(stat.atime.getTime() / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], SAFE_HEAP_STORE((buf + 56 >> 2) * 4, tempI64[0], 4), SAFE_HEAP_STORE((buf + 60 >> 2) * 4, tempI64[1], 4);
          SAFE_HEAP_STORE((buf + 64 >> 2) * 4, 0, 4);
          tempI64 = [Math.floor(stat.mtime.getTime() / 1e3) >>> 0, (tempDouble = Math.floor(stat.mtime.getTime() / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], SAFE_HEAP_STORE((buf + 72 >> 2) * 4, tempI64[0], 4), SAFE_HEAP_STORE((buf + 76 >> 2) * 4, tempI64[1], 4);
          SAFE_HEAP_STORE((buf + 80 >> 2) * 4, 0, 4);
          tempI64 = [Math.floor(stat.ctime.getTime() / 1e3) >>> 0, (tempDouble = Math.floor(stat.ctime.getTime() / 1e3), +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], SAFE_HEAP_STORE((buf + 88 >> 2) * 4, tempI64[0], 4), SAFE_HEAP_STORE((buf + 92 >> 2) * 4, tempI64[1], 4);
          SAFE_HEAP_STORE((buf + 96 >> 2) * 4, 0, 4);
          tempI64 = [stat.ino >>> 0, (tempDouble = stat.ino, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], SAFE_HEAP_STORE((buf + 104 >> 2) * 4, tempI64[0], 4), SAFE_HEAP_STORE((buf + 108 >> 2) * 4, tempI64[1], 4);
          return 0;
        },
      ...
      function heap32VectorToArray(count, firstElement) {
        ...
        for (var i2 = 0; i2 < count; i2++) {
          array.push(SAFE_HEAP_LOAD((firstElement + i2 * 4 >> 2) * 4, 4, 1));
        }
        return array;
      }
          ...
          "fromWireType": function(value) {
            ...
            if (stdStringIsUTF8) {
              ...
              for (var i2 = 0; i2 <= length; ++i2) {
                ...
                if (i2 == length || SAFE_HEAP_LOAD(currentBytePtr, 1, 1) == 0) {
              ...
              for (var i2 = 0; i2 < length; ++i2) {
                a[i2] = String.fromCharCode(SAFE_HEAP_LOAD(payload + i2, 1, 1));
              }
              str = a.join("");
            }
            _free(value);
            ...
            if (stdStringIsUTF8 && valueIsOfTypeString) {
              ...
              if (valueIsOfTypeString) {
                for (var i2 = 0; i2 < length; ++i2) {
                  ...
                  SAFE_HEAP_STORE(ptr + i2, charCode, 1);
                }
              } else {
                for (var i2 = 0; i2 < length; ++i2) {
                  SAFE_HEAP_STORE(ptr + i2, value[i2], 1);
                }
              }
            }
            if (destructors !== null) {
      ...
      function UTF16ToString(ptr, maxBytesToRead) {
        ...
        while (!(idx >= maxIdx) && SAFE_HEAP_LOAD(idx * 2, 2, 1))
          ++idx;
        endPtr = idx << 1;
        if (endPtr - ptr > 32 && UTF16Decoder) {
          ...
          for (var i2 = 0; !(i2 >= maxBytesToRead / 2); ++i2) {
            var codeUnit = SAFE_HEAP_LOAD((ptr + i2 * 2 >> 1) * 2, 2, 0);
            if (codeUnit == 0)
              break;
      ...
      function UTF32ToString(ptr, maxBytesToRead) {
        ...
        while (!(i2 >= maxBytesToRead / 4)) {
          var utf32 = SAFE_HEAP_LOAD((ptr + i2 * 4 >> 2) * 4, 4, 0);
          if (utf32 == 0)
            break;
          ++i2;
          if (utf32 >= 65536) {
      ...
      function emval_lookupTypes(argCount, argTypes) {
        ...
        for (var i2 = 0; i2 < argCount; ++i2) {
          a[i2] = requireRegisteredType(SAFE_HEAP_LOAD((argTypes + i2 * POINTER_SIZE >> 2) * 4, 4, 1), "parameter " + i2);
        }
        return a;
      }
      ...
      var GL = {
        ...
        getSource: function(shader, count, string, length) {
          var source = "";
          for (var i2 = 0; i2 < count; ++i2) {
            var len = length ? SAFE_HEAP_LOAD((length + i2 * 4 >> 2) * 4, 4, 0) : -1;
            source += UTF8ToString(SAFE_HEAP_LOAD((string + i2 * 4 >> 2) * 4, 4, 0), len < 0 ? void 0 : len);
          }
          return source;
        },
      ...
      function _emscripten_glDeleteBuffers(n, buffers) {
        for (var i2 = 0; i2 < n; i2++) {
          var id = SAFE_HEAP_LOAD((buffers + i2 * 4 >> 2) * 4, 4, 0);
      ...
      function _emscripten_glDeleteFramebuffers(n, framebuffers) {
        for (var i2 = 0; i2 < n; ++i2) {
          var id = SAFE_HEAP_LOAD((framebuffers + i2 * 4 >> 2) * 4, 4, 0);
      ...
      function _emscripten_glDeleteRenderbuffers(n, renderbuffers) {
        for (var i2 = 0; i2 < n; i2++) {
          var id = SAFE_HEAP_LOAD((renderbuffers + i2 * 4 >> 2) * 4, 4, 0);
      ...
      function _emscripten_glDeleteTextures(n, textures) {
        for (var i2 = 0; i2 < n; i2++) {
          var id = SAFE_HEAP_LOAD((textures + i2 * 4 >> 2) * 4, 4, 0);
      ...
      function _emscripten_glDeleteVertexArrays(n, vaos) {
        for (var i2 = 0; i2 < n; i2++) {
          var id = SAFE_HEAP_LOAD((vaos + i2 * 4 >> 2) * 4, 4, 0);
      ...
      function __glGenObject(n, buffers, createFunction, objectTable) {
        for (var i2 = 0; i2 < n; i2++) {
          ...
          SAFE_HEAP_STORE((buffers + i2 * 4 >> 2) * 4, id, 4);
        }
      }
      ...
      function writeI53ToI64(ptr, num) {
        ...
        if (deserialized != num)
          warnOnce("writeI53ToI64() out of range: serialized JS Number " + num + " to Wasm heap as bytes lo=0x" + SAFE_HEAP_LOAD((ptr >> 2) * 4, 4, 1).toString(16) + ", hi=0x" + SAFE_HEAP_LOAD((ptr + 4 >> 2) * 4, 4, 1).toString(16) + ", which deserializes back to " + deserialized + " instead!");
      }
            ...
            case "object":
              if (result === null) {
                ...
                for (var i2 = 0; i2 < result.length; ++i2) {
                  switch (type) {
                    case 0:
                      SAFE_HEAP_STORE((p + i2 * 4 >> 2) * 4, result[i2], 4);
                      break;
                    case 2:
                      SAFE_HEAP_STORE_D((p + i2 * 4 >> 2) * 4, result[i2], 4);
                      break;
                    case 4:
                      SAFE_HEAP_STORE(p + i2 >> 0, result[i2] ? 1 : 0, 1);
                      break;
                  }
                }
                return;
      ...
      function _emscripten_glGetProgramInfoLog(program, maxLength, length, infoLog) {
        ...
        if (length)
          SAFE_HEAP_STORE((length >> 2) * 4, numBytesWrittenExclNull, 4);
      }
      ...
      function _emscripten_glUniform1fv(location, count, value) {
        ...
        if (count <= 288) {
          ...
          for (var i2 = 0; i2 < count; ++i2) {
            view[i2] = SAFE_HEAP_LOAD_D((value + 4 * i2 >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniform1iv(location, count, value) {
        ...
        if (count <= 288) {
          ...
          for (var i2 = 0; i2 < count; ++i2) {
            view[i2] = SAFE_HEAP_LOAD((value + 4 * i2 >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniform2fv(location, count, value) {
        ...
        if (count <= 144) {
          ...
          for (var i2 = 0; i2 < 2 * count; i2 += 2) {
            view[i2] = SAFE_HEAP_LOAD_D((value + 4 * i2 >> 2) * 4, 4, 0);
            view[i2 + 1] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 4) >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniform2iv(location, count, value) {
        ...
        if (count <= 144) {
          ...
          for (var i2 = 0; i2 < 2 * count; i2 += 2) {
            view[i2] = SAFE_HEAP_LOAD((value + 4 * i2 >> 2) * 4, 4, 0);
            view[i2 + 1] = SAFE_HEAP_LOAD((value + (4 * i2 + 4) >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniform3fv(location, count, value) {
        ...
        if (count <= 96) {
          ...
          for (var i2 = 0; i2 < 3 * count; i2 += 3) {
            view[i2] = SAFE_HEAP_LOAD_D((value + 4 * i2 >> 2) * 4, 4, 0);
            view[i2 + 1] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 4) >> 2) * 4, 4, 0);
            view[i2 + 2] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 8) >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniform3iv(location, count, value) {
        ...
        if (count <= 96) {
          ...
          for (var i2 = 0; i2 < 3 * count; i2 += 3) {
            view[i2] = SAFE_HEAP_LOAD((value + 4 * i2 >> 2) * 4, 4, 0);
            view[i2 + 1] = SAFE_HEAP_LOAD((value + (4 * i2 + 4) >> 2) * 4, 4, 0);
            view[i2 + 2] = SAFE_HEAP_LOAD((value + (4 * i2 + 8) >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniform4iv(location, count, value) {
        ...
        if (count <= 72) {
          ...
          for (var i2 = 0; i2 < 4 * count; i2 += 4) {
            ...
            view[i2 + 1] = SAFE_HEAP_LOAD((value + (4 * i2 + 4) >> 2) * 4, 4, 0);
            view[i2 + 2] = SAFE_HEAP_LOAD((value + (4 * i2 + 8) >> 2) * 4, 4, 0);
            view[i2 + 3] = SAFE_HEAP_LOAD((value + (4 * i2 + 12) >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _emscripten_glUniformMatrix2fv(location, count, transpose, value) {
        ...
        if (count <= 72) {
          ...
          for (var i2 = 0; i2 < 4 * count; i2 += 4) {
            ...
            view[i2 + 1] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 4) >> 2) * 4, 4, 0);
            view[i2 + 2] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 8) >> 2) * 4, 4, 0);
            view[i2 + 3] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 12) >> 2) * 4, 4, 0);
          }
        } else {
          var view = HEAPF32.subarray(value >> 2, value + count * 16 >> 2);
        }
      ...
      function _emscripten_glUniformMatrix3fv(location, count, transpose, value) {
        ...
        if (count <= 32) {
          ...
          for (var i2 = 0; i2 < 9 * count; i2 += 9) {
            ...
            view[i2 + 2] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 8) >> 2) * 4, 4, 0);
            view[i2 + 3] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 12) >> 2) * 4, 4, 0);
            view[i2 + 4] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 16) >> 2) * 4, 4, 0);
            view[i2 + 5] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 20) >> 2) * 4, 4, 0);
            view[i2 + 6] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 24) >> 2) * 4, 4, 0);
            view[i2 + 7] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 28) >> 2) * 4, 4, 0);
            view[i2 + 8] = SAFE_HEAP_LOAD_D((value + (4 * i2 + 32) >> 2) * 4, 4, 0);
          }
        } else {
      ...
      function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
        try {
          ...
          tempI64 = [stream.position >>> 0, (tempDouble = stream.position, +Math.abs(tempDouble) >= 1 ? tempDouble > 0 ? (Math.min(+Math.floor(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], SAFE_HEAP_STORE((newOffset >> 2) * 4, tempI64[0], 4), SAFE_HEAP_STORE((newOffset + 4 >> 2) * 4, tempI64[1], 4);
      ...
      Module["_emscripten_stack_set_limits"] = function() {
        return (Module["_emscripten_stack_set_limits"] = Module["asm"]["emscripten_stack_set_limits"]).apply(null, arguments);
      };
      ...
      Module["dynCall_ii"] = createExportWrapper("dynCall_ii");
      Module["dynCall_vi"] = createExportWrapper("dynCall_vi");
      Module["dynCall_ji"] = createExportWrapper("dynCall_ji");
      Module["dynCall_iii"] = createExportWrapper("dynCall_iii");
      Module["dynCall_iij"] = createExportWrapper("dynCall_iij");
      Module["dynCall_viiij"] = createExportWrapper("dynCall_viiij");
      Module["dynCall_viii"] = createExportWrapper("dynCall_viii");
      Module["dynCall_vii"] = createExportWrapper("dynCall_vii");
      Module["dynCall_v"] = createExportWrapper("dynCall_v");
      Module["dynCall_viij"] = createExportWrapper("dynCall_viij");
      Module["dynCall_fij"] = createExportWrapper("dynCall_fij");
      Module["dynCall_viiii"] = createExportWrapper("dynCall_viiii");
      Module["dynCall_fii"] = createExportWrapper("dynCall_fii");
      Module["dynCall_fif"] = createExportWrapper("dynCall_fif");
      Module["dynCall_iiiff"] = createExportWrapper("dynCall_iiiff");
      Module["dynCall_vijiii"] = createExportWrapper("dynCall_vijiii");
      Module["dynCall_viiiii"] = createExportWrapper("dynCall_viiiii");
      Module["dynCall_iiiiii"] = createExportWrapper("dynCall_iiiiii");
      Module["dynCall_iiii"] = createExportWrapper("dynCall_iiii");
      Module["dynCall_vij"] = createExportWrapper("dynCall_vij");
      Module["dynCall_iiiiiii"] = createExportWrapper("dynCall_iiiiiii");
      Module["dynCall_viiff"] = createExportWrapper("dynCall_viiff");
      Module["dynCall_iiij"] = createExportWrapper("dynCall_iiij");
      Module["dynCall_iiiii"] = createExportWrapper("dynCall_iiiii");
      Module["dynCall_viif"] = createExportWrapper("dynCall_viif");
      Module["dynCall_viiffff"] = createExportWrapper("dynCall_viiffff");
      Module["dynCall_iiifii"] = createExportWrapper("dynCall_iiifii");
      Module["dynCall_iiiffii"] = createExportWrapper("dynCall_iiiffii");
      Module["dynCall_iiiij"] = createExportWrapper("dynCall_iiiij");
      Module["dynCall_viiiiii"] = createExportWrapper("dynCall_viiiiii");
      Module["dynCall_iiiiiiii"] = createExportWrapper("dynCall_iiiiiiii");
      Module["dynCall_jii"] = createExportWrapper("dynCall_jii");
      Module["dynCall_jij"] = createExportWrapper("dynCall_jij");
      Module["dynCall_fi"] = createExportWrapper("dynCall_fi");
      Module["dynCall_jijf"] = createExportWrapper("dynCall_jijf");
      Module["dynCall_i"] = createExportWrapper("dynCall_i");
      Module["dynCall_vif"] = createExportWrapper("dynCall_vif");
      Module["dynCall_di"] = createExportWrapper("dynCall_di");
      Module["dynCall_vid"] = createExportWrapper("dynCall_vid");
      Module["dynCall_iiiifii"] = createExportWrapper("dynCall_iiiifii");
      Module["dynCall_iiiffi"] = createExportWrapper("dynCall_iiiffi");
      Module["dynCall_vifffffffff"] = createExportWrapper("dynCall_vifffffffff");
      Module["dynCall_iifffffffff"] = createExportWrapper("dynCall_iifffffffff");
      Module["dynCall_iiff"] = createExportWrapper("dynCall_iiff");
      Module["dynCall_iif"] = createExportWrapper("dynCall_iif");
      Module["dynCall_viff"] = createExportWrapper("dynCall_viff");
      Module["dynCall_viffffff"] = createExportWrapper("dynCall_viffffff");
      Module["dynCall_dii"] = createExportWrapper("dynCall_dii");
      Module["dynCall_viid"] = createExportWrapper("dynCall_viid");
      Module["dynCall_iiiiffi"] = createExportWrapper("dynCall_iiiiffi");
      Module["dynCall_fiii"] = createExportWrapper("dynCall_fiii");
      Module["dynCall_viiif"] = createExportWrapper("dynCall_viiif");
      Module["dynCall_viifffffffff"] = createExportWrapper("dynCall_viifffffffff");
      Module["dynCall_viiffffff"] = createExportWrapper("dynCall_viiffffff");
      Module["dynCall_viifff"] = createExportWrapper("dynCall_viifff");
      Module["dynCall_viiifii"] = createExportWrapper("dynCall_viiifii");
      Module["dynCall_viiiiiii"] = createExportWrapper("dynCall_viiiiiii");
      Module["dynCall_viffff"] = createExportWrapper("dynCall_viffff");
      Module["dynCall_vifff"] = createExportWrapper("dynCall_vifff");
      Module["dynCall_iiffi"] = createExportWrapper("dynCall_iiffi");
      Module["dynCall_iifii"] = createExportWrapper("dynCall_iifii");
      Module["dynCall_iiifi"] = createExportWrapper("dynCall_iiifi");
      Module["dynCall_iiiiij"] = createExportWrapper("dynCall_iiiiij");
      Module["dynCall_iijj"] = createExportWrapper("dynCall_iijj");
      Module["dynCall_vffff"] = createExportWrapper("dynCall_vffff");
      Module["dynCall_viiiiiiii"] = createExportWrapper("dynCall_viiiiiiii");
      Module["dynCall_vf"] = createExportWrapper("dynCall_vf");
      Module["dynCall_viiiiiiiii"] = createExportWrapper("dynCall_viiiiiiiii");
      Module["dynCall_viiiiiiiiii"] = createExportWrapper("dynCall_viiiiiiiiii");
      Module["dynCall_fiifiii"] = createExportWrapper("dynCall_fiifiii");
      Module["dynCall_iiifiii"] = createExportWrapper("dynCall_iiifiii");
      Module["dynCall_viiifiii"] = createExportWrapper("dynCall_viiifiii");
      Module["dynCall_vifii"] = createExportWrapper("dynCall_vifii");
      Module["dynCall_viifd"] = createExportWrapper("dynCall_viifd");
      Module["dynCall_viddi"] = createExportWrapper("dynCall_viddi");
      Module["dynCall_viiiiiffii"] = createExportWrapper("dynCall_viiiiiffii");
      Module["dynCall_jiiii"] = createExportWrapper("dynCall_jiiii");
